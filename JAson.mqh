//+----------------------------------------------------------------------------------------------+
//|                                                                                        JAson |
//|            This software is licensed under the MIT https://github.com/gustavosouzalima/JAson |
//+----------------------------------------------------------------------------------------------+
#property copyright "Copyright © 2006-2025"
...
public:
    ...
    bool ToArrStr(string &arr[])
    {
        if (m_type != jtARRAY) 
        {
            Print("Erro: ToArrStr() - O tipo não é um array");
            return false;
        }
        ...
        if (ArrayResize(arr, size) != size)
        {
            Print("Erro: ToArrStr() - Falha ao redimensionar array");
            return false;
        }
